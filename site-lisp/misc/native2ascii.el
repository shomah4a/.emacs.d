...
(defcustom native2ascii-command-format "native2ascii -encoding sjis"
  "native2ascii command"
  :group 'native2ascii
  :type '(choice (const :tag "Default" "native2ascii -encoding sjis")
				 (string :tag "String")))

(defcustom ascii2native-command-format "native2ascii -reverse -encoding sjis"
  "ascii2native command"
  :group 'native2ascii
  :type '(choice (const :tag "Default" "native2ascii -reverse -encoding sjis")
				 (string :tag "String")))
